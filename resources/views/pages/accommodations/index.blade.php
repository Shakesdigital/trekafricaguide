...
<section class="page-hero" style="--hero-image:url('https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?auto=format&fit=crop&w=1800&q=80');">
    <div class="container reveal">
        ...
        <p>Accommodation is presented as part of the full travel decision, so travelers can compare lodge style, location logic, and trip pacing instead of choosing a stay in isolation.</p>
    </div>
</section>
...
<section class="section-block patterned">
    <div class="container">
        <div class="section-head reveal">
            ...
            <h2>Browse camps, lodges, boutique hotels, and practical stopovers</h2>
            <p>Some travelers need a honeymoon-ready tented camp, others need an efficient city overnight before a game drive. This directory helps them compare both without losing destination context.</p>
        </div>
