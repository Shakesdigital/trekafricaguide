...
<section class="page-hero">
    @include('site.partials.image-slot', ['image' => 'image-slot:accommodations-index-hero', 'alt' => 'Maasai Mara landscape representing accommodation destinations', 'class' => 'page-hero__slot'])
