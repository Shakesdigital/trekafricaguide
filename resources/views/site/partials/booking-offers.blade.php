...
@if($offers->isNotEmpty())
    <div class="booking-offers">
        ...
        @endforeach
        @if(($searchContext['rooms'] ?? null) && ($searchContext['mode'] ?? '') === 'accommodations')<small>Room count is sent as planning context; reconfirm rooms, rates, and availability on the provider.</small>@endif
    </div>
@endif
