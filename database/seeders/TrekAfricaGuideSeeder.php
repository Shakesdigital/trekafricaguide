...
class TrekAfricaGuideSeeder extends Seeder
{
    ...
    private function seedBookingOffers(): void
    {
        ...
        foreach (Accommodation::query()->get() as $stay) {
            ...
            $stay->bookingOffers()->create(array_merge(['provider'=>'booking','label'=>$hasExactBookingPage ? 'View stay on Booking.com' : 'Search this stay on Booking.com','source_url'=>$url,'stay22_provider'=>'booking','affiliate_supported'=>true,'active'=>true,'sort_order'=>10], $snapshot));
        }
        $gyg = [
        ...
        foreach (Attraction::query()->get() as $item) {
            $item->bookingOffers()->create(['provider'=>'getyourguide','label'=>'View attraction options on GetYourGuide','source_url'=>$gyg[$item->slug] ?? 'https://www.getyourguide.com/s/?q='.urlencode($item->name),'stay22_provider'=>'getyourguide','affiliate_supported'=>true,'active'=>true,'sort_order'=>10]);
            $item->bookingOffers()->create(['provider'=>'tripadvisor','label'=>'Read visitor reviews on Tripadvisor','source_url'=>'https://www.tripadvisor.com/Search?q='.urlencode($item->name.' '.$item->country->name),'stay22_provider'=>'tripadvisor','affiliate_supported'=>true,'active'=>true,'sort_order'=>20]);
        }
    }
    ...
    private function settings(): array
    {
        return [
            ...
            ['group_name' => 'general', 'key' => 'site_tagline', 'value' => 'Africa travel listings, destination insight, attractions, stays, and practical planning guidance in one place.'],
            ...
            ['group_name' => 'seo', 'key' => 'default_meta_description', 'value' => 'Explore African destinations, attractions, and accommodations with practical travel context before continuing to external booking providers.'],
    ...
    private function pageSections(): array
    {
        return [
            [
                ...
                'body' => 'Trek Africa Guide brings destinations, attractions, accommodations, and practical planning notes into one place, so travelers can compare what fits their route before continuing to external booking providers.',
                ...
                'meta' => [
                    ...
                    'slides' => [
                        ...
                        [
                            ...
                            'title' => 'Rainforest parks, island nature, low-density wildlife, and expedition-style planning.',
                            'body' => 'Compare Sao Tome and Principe, Cameroon, Gabon, and Republic of the Congo with clear notes on access, guide support, park logistics, and changing conditions.',
                            'image_slot' => 'home-hero-central-africa',
                        ],
                    ],
                ],
                'sort_order' => 1,
            ...
            [
                ...
                'body' => 'Some travelers come for wildlife and primates, others for coast, history, design, desert silence, family-friendly resorts, or a meaningful heritage journey. The best trip starts by matching the region, country, attraction, and stay to the kind of experience you actually want.',
            ...
            [
                ...
                'title' => 'Five useful starting points for a smarter Africa trip.',
                'body' => 'Use the regions to compare travel moods first, then narrow into destination countries, attractions, nearby stays, and booking paths.',
                'sort_order' => 3,
            ],
            [
                'page_key' => 'home',
                ...
                'body' => 'Compare place-specific summaries, location context, indicative pricing where verified, and clearly named internal detail pages before opening provider options.',
                'sort_order' => 4,
            ],
            [
                'page_key' => 'home',
    ...
    private function regions(): array
    {
        return [
            ...
            [
                'slug' => 'central-africa',
                'name' => 'Central Africa',
                'hero_title' => 'Central Africa rewards careful planners with rainforest, islands, rare wildlife, and quieter routes.',
                'hero_text' => 'Choose this region if you want Sao Tome island nature, Cameroon variety, Gabon forest-and-coast wildlife, or Congo Basin expeditions with specialist logistics.',
                'overview' => 'Central Africa is lower-volume and more logistics-sensitive than Africa s busiest tourism regions, but it offers rare forest ecosystems, volcanic landscapes, island biodiversity, mandrill and gorilla habitats, and expedition-style wildlife travel. The most practical visitor choices are Sao Tome and Principe, Cameroon, Gabon, and Republic of the Congo, while routes such as eastern DRC require separate safety review because park access and travel advisories change quickly.',
                'countries_intro' => 'These countries suit travelers who value nature, culture, and low-density exploration, and who are comfortable verifying permits, roads, guides, health requirements, and current safety guidance before committing.',
                'hero_image_url' => '/images/stock/destinations/odzala-kokoua-national-park.jpg',
                'hero_image_alt' => 'Central African rainforest landscape',
            ],
        ];
    }
    ...
    private function countries(): array
    {
        return [
            ...
            $this->country('east-africa', 'mauritius', 'Mauritius', 'Mauritius is an easy Indian Ocean destination with beaches, lagoon resorts, mountain scenery, Creole culture, and family-friendly infrastructure.', 'Best for travelers who want a polished beach base with enough nature and culture to avoid a purely resort-only trip.', 'Most visitors arrive through Sir Seewoosagur Ramgoolam International Airport and move by private transfer, rental car, or guided day tour.', 'May to December is generally drier and comfortable, while January to March can be hotter, wetter, and more cyclone-aware.'),
            $this->country('east-africa', 'seychelles', 'Seychelles', 'Seychelles is a high-value island destination known for granite beaches, marine parks, forest reserves, and carefully managed island-hopping.', 'Best for couples, beach-focused trips, and travelers who want nature-rich island time with a premium feel.', 'Mahe is the main gateway, with ferries or short flights to Praslin and La Digue.', 'April to May and October to November often bring calmer seas, while trade-wind seasons influence beach and ferry conditions.'),
            ...
            $this->country('west-africa', 'nigeria', 'Nigeria', 'Nigeria is visited for Lagos energy, music, food, fashion, business travel, heritage sites, and growing domestic leisure routes.', 'Best for travelers with a specific cultural, family, events, or business reason who want a guided introduction to a huge, complex country.', 'Lagos and Abuja are the main gateways, with domestic flights and private drivers more realistic than self-drive travel for most visitors.', 'Dry months from November to March are generally more comfortable for city movement, festivals, and road visibility.'),
            $this->country('west-africa', 'the-gambia', 'The Gambia', 'The Gambia is a compact winter-sun destination with Atlantic beaches, birding, river trips, and accessible community tourism.', 'Best for travelers wanting a manageable West Africa introduction with beach hotels and soft nature excursions.', 'Most visitors arrive through Banjul and stay along the coast before adding river or birding day trips.', 'November to April is the classic dry-season window for beaches and birding.'),
            $this->country('west-africa', 'cote-divoire', 'Cote d Ivoire', 'Cote d Ivoire draws travelers for Abidjan, Grand-Bassam heritage, beaches, national parks, music, art, and strong urban culture.', 'Best for travelers who want a francophone city-and-coast route with heritage and contemporary culture.', 'Abidjan is the main gateway, with road transfers to Grand-Bassam, Assinie, Yamoussoukro, and park routes.', 'November to March is generally the most comfortable travel window, though coastal humidity remains part of the experience.'),
            ...
            $this->country('southern-africa', 'mozambique', 'Mozambique', 'Mozambique is visited for Indian Ocean beaches, island lodges, diving, dhow culture, seafood, and safari-beach combinations with neighboring countries.', 'Best for travelers who want a beach extension that feels more remote and less standardized than a resort-only island.', 'Maputo, Vilankulo, and Nampula shape the main access patterns, with transfers often arranged through lodges or operators.', 'May to October is usually the most comfortable dry-season window, while cyclone-season conditions require extra checking.'),
            ...
            $this->country('central-africa', 'sao-tome-and-principe', 'Sao Tome and Principe', 'Sao Tome and Principe is a small island country visited for rainforest hikes, volcanic scenery, cocoa heritage, quiet beaches, and whale or turtle seasons.', 'Best for travelers who want a nature-rich island trip with low crowds and a slower pace.', 'International arrivals land on Sao Tome, with Principe reached by domestic flight and onward lodge transfer.', 'June to September is generally drier, while wildlife seasons for turtles and whales vary by island and month.'),
            $this->country('central-africa', 'cameroon', 'Cameroon', 'Cameroon is often called Africa in miniature because it combines coast, rainforest, mountains, savannah, cultural diversity, and city life.', 'Best for experienced travelers who want variety and are comfortable checking current regional access and guide requirements.', 'Douala and Yaounde are the main gateways, with guided road transfers or domestic flights depending on the route.', 'November to February is generally drier for many routes, though conditions vary sharply between coast, highland, and north.'),
            $this->country('central-africa', 'gabon', 'Gabon', 'Gabon is a rainforest-and-coast wildlife destination known for national parks, forest elephants, mandrills, gorillas, turtles, and low-density expedition travel.', 'Best for wildlife travelers who value rarity, conservation, and quiet parks over easy logistics.', 'Libreville is the main gateway, with flights, road transfers, trains, or park-arranged logistics depending on the destination.', 'June to September is a key dry-season window for forest travel, while wildlife events such as turtle nesting and whale season are more specific.'),
            $this->country('central-africa', 'republic-of-the-congo', 'Republic of the Congo', 'Republic of the Congo is a Congo Basin travel choice focused on rainforest, western lowland gorillas, forest elephants, rivers, and specialist lodge operations.', 'Best for travelers seeking a guided rainforest expedition with rare wildlife and high logistical support.', 'Brazzaville is the gateway, with charter or scheduled connections and lodge transfers into northern forest parks.', 'Dryer windows can improve movement, but rainforest travel remains humid, remote, and highly dependent on lodge logistics.'),
        ];
    }
    ...
    private function attractions(): array
    {
        return [
            ...
            $this->attraction('mauritius', 'black-river-gorges', 'Black River Gorges National Park', 'Southwestern Mauritius', 'Mauritius nature anchor with forest trails, waterfalls, viewpoints, and endemic birds.', 'Black River Gorges is the clearest counterweight to resort-only Mauritius because it adds mountain forest, hiking, and island biodiversity to a beach itinerary.', 'Most travelers visit by rental car, private driver, or guided day tour from the west or south coast. Trail conditions can shift after rain, so choose walks by fitness and weather.', 'May to December is generally drier and more comfortable for hiking, though showers remain possible in the highlands.', 4.6, 612, 'Free entry'),
            $this->attraction('seychelles', 'vallee-de-mai', 'Vallee de Mai Nature Reserve', 'Praslin, Seychelles', 'UNESCO-listed palm forest famous for coco de mer palms and rare island birdlife.', 'Vallee de Mai gives Seychelles a strong nature focus beyond beaches, with short forest trails, endemic palms, and a manageable half-day visit on Praslin.', 'Reach Praslin by ferry or short flight from Mahe, then continue by taxi, rental car, or local bus to the reserve entrance.', 'April to May and October to November often bring calmer conditions for island-hopping, while forest visits are possible year-round.', 4.6, 821, 'From $35'),
            ...
            $this->attraction('nigeria', 'lagos-and-lekki', 'Lagos & Lekki Conservation Centre', 'Lagos, Nigeria', 'Urban culture, Atlantic energy, and a canopy-walk nature stop in one high-intensity gateway.', 'Lagos is the most recognizable Nigeria travel gateway, while Lekki Conservation Centre gives visitors a structured nature break from the city s music, food, art, and coast scene.', 'Arrive through Lagos, use trusted drivers, and plan movement by neighborhood because traffic shapes the day. Lekki works best with pre-arranged transport and a realistic buffer.', 'November to March is usually more comfortable for city movement and outdoor visits.', 4.4, 1180, 'From $8'),
            $this->attraction('the-gambia', 'river-gambia-national-park', 'River Gambia National Park', 'Central River Region, The Gambia', 'River islands, chimpanzee rehabilitation context, birding, and boat-based nature viewing.', 'River Gambia National Park adds depth to a coast-based Gambia trip by shifting the focus inland to birdlife, river movement, and conservation interpretation.', 'Most travelers visit with an operator from coastal hotels or as part of an up-country route. Boat access and guide coordination should be arranged in advance.', 'November to April is the easiest dry-season window for birding and river travel.', 4.4, 156, 'Tour quoted'),
            $this->attraction('cote-divoire', 'grand-bassam', 'Grand-Bassam', 'Near Abidjan, Cote d Ivoire', 'UNESCO-listed colonial-era town, beach context, museums, and heritage streets near Abidjan.', 'Grand-Bassam is the most practical heritage day or overnight stop from Abidjan, pairing historic architecture with Atlantic-coast atmosphere.', 'Drive from Abidjan with a private driver or organized guide. Check museum hours, beach safety, and traffic timing before setting out.', 'November to March is generally more comfortable for walking and coastal touring.', 4.5, 309, 'From $10'),
            ...
            $this->attraction('mozambique', 'bazaruto-archipelago', 'Bazaruto Archipelago', 'Vilankulo coast, Mozambique', 'Marine national park with island lodges, dhow trips, diving, snorkeling, and sandbank scenery.', 'Bazaruto is Mozambique s clearest premium beach-and-marine anchor, especially for travelers pairing safari elsewhere with a quieter Indian Ocean finish.', 'Fly into Vilankulo and continue by boat or helicopter transfer depending on lodge location and sea conditions.', 'May to October is usually the most comfortable dry-season window for beach and marine activities.', 4.8, 267, 'Park fees vary'),
            ...
            $this->attraction('sao-tome-and-principe', 'obo-natural-park', 'Obo Natural Park', 'Sao Tome and Principe', 'Rainforest, volcanic peaks, waterfalls, cocoa-route scenery, and island biodiversity.', 'Obo Natural Park is the nature heart of Sao Tome and Principe, giving travelers forest trails, birdlife, waterfalls, and a strong reason to look beyond beaches.', 'Base on Sao Tome or Principe depending on the trail focus, then use local guides and lodge-arranged transfers. Rain can affect paths quickly.', 'June to September is usually drier, but rainforest visits require flexible expectations year-round.', 4.6, 132, 'Guide fees vary'),
            $this->attraction('cameroon', 'mount-cameroon', 'Mount Cameroon', 'Southwest Cameroon', 'West Africa s highest mountain, volcanic landscapes, hiking routes, and coastal access from Limbe and Buea.', 'Mount Cameroon is Cameroon s strongest adventure anchor for travelers who want a demanding hike and a clear sense of the country s geographic variety.', 'Travel through Douala toward Buea with a licensed local guide. Check current regional security advice, race or event timing, and trail conditions before committing.', 'November to February is generally drier and more suitable for hiking, though mountain weather changes quickly.', 4.5, 214, 'Guide fees vary'),
            $this->attraction('gabon', 'loango-national-park', 'Loango National Park', 'Gabon Atlantic coast', 'Forest, savannah, lagoon, beach, elephants, hippos, turtles, whales, and low-density wildlife travel.', 'Loango is one of Africa s most distinctive park ideas because forest wildlife meets the Atlantic coast in a setting that still feels expeditionary.', 'Routes usually start in Libreville and continue via park-arranged flights, road, boat, or lodge logistics. Confirm operating season and transfers before paying.', 'June to September is useful for drier movement and whale season, while turtle and wildlife timing varies by month.', 4.7, 98, 'Package based'),
            $this->attraction('republic-of-the-congo', 'odzala-kokoua-national-park', 'Odzala-Kokoua National Park', 'Northern Republic of the Congo', 'Congo Basin rainforest with western lowland gorillas, forest elephants, bais, rivers, and specialist camps.', 'Odzala is for travelers who want a serious rainforest expedition with expert guiding, rare wildlife, and a lodge system built around remote access.', 'Most visitors route through Brazzaville and continue by scheduled charter or lodge-arranged transfer to camps near the park.', 'Dryer periods can help movement, but rainforest conditions remain humid and logistics are highly lodge-dependent.', 4.8, 87, 'Package based'),
        ];
    }
    ...
    private function regionResearchNote(string $slug): string
    {
        return match ($slug) {
            ...
            'central-africa' => 'The region rewards travelers who plan carefully around rainforest logistics, island access, specialist guides, permits, health requirements, and current official safety advice rather than expecting mass-market ease.',
            default => '',
        };
    }
    ...
    private function countryResearchNote(string $slug): string
    {
        return match ($slug) {
            ...
            'mauritius' => 'The best trips balance beach comfort with Black River Gorges, Chamarel, Le Morne, botanical gardens, food culture, and coast-by-coast weather differences.',
            'seychelles' => 'Island choice matters: Mahe is the gateway, Praslin anchors Vallee de Mai, La Digue offers slower beach days, and marine conditions shape ferry and snorkeling plans.',
            ...
            'nigeria' => 'Lagos, Abuja, Osogbo, Calabar, Yankari, and cultural-event travel can be rewarding, but visitors should use current local guidance, trusted transport, and city-by-city planning.',
            'the-gambia' => 'Short distances make beaches, birding, community tourism, and river excursions easy to combine, but up-country trips still need guide and boat coordination.',
            'cote-divoire' => 'Abidjan, Grand-Bassam, Assinie, Yamoussoukro, and park routes each require different pacing, with private transport and current road guidance improving the experience.',
            ...
            'mozambique' => 'Beach logistics are highly place-specific: Bazaruto, Tofo, Maputo, Ilha de Mocambique, and the northern islands all need separate checks on flights, transfers, marine conditions, and season.',
            ...
            'sao-tome-and-principe' => 'Rainforest trails, cocoa rocas, beaches, turtles, whales, and Príncipe biodiversity are the core appeal, but domestic flights and lodge transfers should be confirmed early.',
            'cameroon' => 'The country s variety is real, but travelers should check current access carefully by region and use local guides for Mount Cameroon, Limbe, highland, and northern routes.',
            'gabon' => 'Loango, Lope, Ivindo, Pongara, and mandrill or turtle seasons reward wildlife-focused planners who can handle park-arranged transfers and operating-season constraints.',
            'republic-of-the-congo' => 'Odzala and Congo Basin travel are specialist journeys where lodge logistics, health requirements, charter timing, and rainforest conditions are central to the product.',
            default => '',
        };
    }
    ...
    private function accommodations(): array
    {
        return [
            ...
            $this->stay('mauritius', 'black-river-gorges', 'lakaz-chamarel-exclusive-lodge', 'Lakaz Chamarel Exclusive Lodge', 'Eco-lodge', 'Chamarel, near Black River Gorges', 'A small lodge base in the southwest for travelers pairing forest trails, viewpoints, and coast time.', 'Lakaz Chamarel works because it sits close to the island s mountain and forest side rather than only the resort beach belt.', 'A rental car, driver, or guided excursions make the stay much easier for Black River Gorges, Chamarel, and Le Morne routing.', ['Forest-edge setting', 'Pool', 'Wellness focus', 'Southwest access'], 'From $280 / night', 'https://www.lakazchamarel.com/', false, 4.7, 411),
            $this->stay('seychelles', 'vallee-de-mai', 'coco-de-mer-hotel', 'Coco de Mer Hotel and Black Parrot Suites', 'Beach hotel', 'Anse Bois de Rose, Praslin', 'A Praslin base that balances beach time with practical access to Vallee de Mai and island-hopping.', 'Coco de Mer is useful for travelers who want Seychelles nature without moving hotels every night.', 'Check ferry timing, sea conditions, and whether island transfers or rental car arrangements are included.', ['Praslin base', 'Beach access', 'Pool', 'Island tour support'], 'From $360 / night', 'https://www.cocodemer.com/', false, 4.5, 806),
            ...
            $this->stay('nigeria', 'lagos-and-lekki', 'the-wheatbaker-lagos', 'The Wheatbaker Lagos', 'Boutique city hotel', 'Ikoyi, Lagos', 'A calm Lagos base for travelers combining business, culture, restaurants, galleries, and guided Lekki visits.', 'The Wheatbaker fits Lagos because location, driver coordination, and a quieter return point matter as much as room style.', 'Plan each day by traffic zone and use trusted transport for Lekki, Victoria Island, Ikoyi, and airport movements.', ['Ikoyi location', 'Pool', 'Restaurant', 'Driver coordination'], 'From $280 / night', 'https://www.thewheatbakerlagos.com/', false, 4.5, 523),
            $this->stay('the-gambia', 'river-gambia-national-park', 'mandina-lodges', 'Mandina Lodges', 'River eco-lodge', 'Makasautu Forest, near the River Gambia', 'A lodge option for travelers who want birding, river atmosphere, and forest context beyond the beach strip.', 'Mandina works as a nature-focused Gambia stay because it slows the pace and supports guided river and forest activities.', 'Confirm seasonal opening, transfer time from coastal hotels, meal plans, and river excursion availability.', ['River setting', 'Birding', 'Guided excursions', 'Eco-lodge atmosphere'], 'From $210 / night', 'https://www.mandinalodges.com/', false, 4.6, 198),
            $this->stay('cote-divoire', 'grand-bassam', 'hotel-la-maison-de-la-lagune', 'La Maison de la Lagune', 'Lagoon guesthouse', 'Near Grand-Bassam and Abidjan coast', 'A quieter lagoon-side base for travelers pairing Abidjan, Grand-Bassam, and the coast.', 'This stay works when the route needs a softer overnight outside Abidjan after heritage touring.', 'Use a driver for Abidjan and Grand-Bassam movements, and confirm current operating status before booking.', ['Lagoon setting', 'Pool', 'Coastal access', 'Quiet overnight base'], 'Rates on request', 'https://www.tripadvisor.com/Search?q=La%20Maison%20de%20la%20Lagune%20Cote%20d%20Ivoire', false, 4.3, 121),
            ...
            $this->stay('mozambique', 'bazaruto-archipelago', 'anantara-bazaruto-island-resort', 'Anantara Bazaruto Island Resort', 'Island resort', 'Bazaruto Island, Mozambique', 'A premium island base for marine park access, diving, beach time, and dhow-style excursions.', 'Anantara Bazaruto is route-logical because the stay solves island access and activity coordination inside the archipelago.', 'Verify boat or helicopter transfers from Vilankulo, marine park fees, activity inclusions, and cyclone-season terms.', ['Island location', 'Diving', 'Spa', 'Marine excursions'], 'From $620 / night', 'https://www.anantara.com/en/bazaruto-island', false, 4.7, 512),
            ...
            $this->stay('sao-tome-and-principe', 'obo-natural-park', 'sundy-praia-principe', 'Sundy Praia', 'Luxury tented villa lodge', 'Principe Island', 'A high-end island stay for travelers pairing rainforest, beaches, cocoa heritage, and Príncipe nature.', 'Sundy Praia works because it places travelers close to Príncipe s protected nature while keeping logistics supported.', 'Confirm inter-island flight timing, lodge transfers, seasonal wildlife priorities, and included activities before payment.', ['Beach villas', 'Rainforest access', 'Guided activities', 'Island transfers'], 'From $750 / night', 'https://www.sundypraia.com/', false, 4.8, 166),
            $this->stay('cameroon', 'mount-cameroon', 'fini-hotel-bobende', 'Fini Hotel Bobende', 'Coastal hotel', 'Limbe, near Mount Cameroon', 'A practical coastal base for travelers combining Limbe, Buea, and Mount Cameroon logistics.', 'Fini Hotel Bobende is useful when travelers want a soft landing near the coast before or after mountain touring.', 'Check current road conditions, guide arrangements for Mount Cameroon, and regional travel advice before confirming.', ['Coastal setting', 'Pool', 'Limbe access', 'Driver coordination'], 'From $130 / night', 'https://www.tripadvisor.com/Search?q=Fini%20Hotel%20Bobende%20Limbe%20Cameroon', false, 4.0, 138),
            $this->stay('gabon', 'loango-national-park', 'loango-lodge', 'Loango Lodge', 'Safari lodge', 'Loango National Park, Gabon', 'A specialist lodge base for forest, lagoon, beach, and wildlife excursions in Loango.', 'Loango Lodge works because independent park logistics are difficult; travelers need a stay that can coordinate transfers and guided activities.', 'Confirm operating season, flights or road and boat transfers, activity program, and wildlife timing before booking.', ['Park logistics', 'Guided wildlife activities', 'Lagoon access', 'Beach and forest setting'], 'Package based', 'https://www.tripadvisor.com/Search?q=Loango%20Lodge%20Gabon', false, 4.4, 74),
            $this->stay('republic-of-the-congo', 'odzala-kokoua-national-park', 'ngaga-camp', 'Ngaga Camp', 'Rainforest safari camp', 'Odzala-Kokoua National Park', 'A specialist Congo Basin camp for western lowland gorilla tracking and rainforest immersion.', 'Ngaga Camp is the right style of stay for Odzala because access, guiding, and conservation protocols are inseparable from the lodge operation.', 'Confirm charter timing, gorilla tracking rules, health requirements, luggage limits, and seasonal camp operations before payment.', ['Gorilla tracking', 'Rainforest setting', 'Specialist guides', 'Lodge-arranged transfers'], 'Package based', 'https://www.odzala.com/', false, 4.8, 64),
        ];
    }
    ...
    private function countryPlanningTips(string $slug): string
    {
        return match ($slug) {
            ...
            default => 'Use this guide to compare what the country does best, how its main attractions connect, where stays fit into the route, and which details to verify before committing to a booking.',
        };
    }
